sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("demo/com/vn/app", ".html");
			sHash = sHash || "";
		...
		return Opa5.extend("demo.com.vn.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["demo/com/vn/localService/mockserver"], function (mockserver) {
